...
export default function FAQ() {
  ...
  return (
    <section
      id="faq"
      className="bg-navy px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24"
    >
      <div className="max-w-3xl mx-auto">

        <FadeIn>
          <div className="mb-10 sm:mb-12">
            <p className="text-[10px] uppercase tracking-[0.25em] text-brass-light mb-4 text-center">
              FAQ
            </p>
          ...
          {faqs.map((f, i) => (
            <FadeIn key={f.q} delay={i * 0.06}>
              ...
              <div className="border-b border-white/10">
                ...
                >
                  <span className="font-heading text-base sm:text-lg text-white">
                    {f.q}
                  </span>

                  <span className="shrink-0 text-brass-light text-xl">
                    {open === i ? "−" : "+"}
                  </span>
                </button>
