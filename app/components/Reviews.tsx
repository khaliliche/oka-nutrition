...
export default function Reviews() {
  return (
    <section
      id="reviews"
      className="bg-grey-bg px-5 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24"
    >
      <div className="max-w-6xl mx-auto">

        <FadeIn>
          <div className="max-w-xl mb-10 md:mb-14">
            <p className="text-[10px] uppercase tracking-[0.22em] text-charcoal-light mb-3">
              Avis clients
            </p>

            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl text-navy leading-[1.05]">
          ...
          {reviews.map((review, index) => (
            <FadeIn key={review.name} delay={index * 0.1}>
              <article className="bg-white p-6 sm:p-7 md:p-8 h-full flex flex-col">
                ...
                <blockquote className="font-heading text-lg md:text-xl text-navy leading-relaxed flex-1">
                  “{review.text}”
                </blockquote>
