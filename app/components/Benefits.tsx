      ...
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn>
          <div className="max-w-xl mb-12 lg:mb-16">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-[2.8rem] leading-[1.05] text-ink">
        ...
        <div className="grid md:grid-cols-3 border-t border-black/10">
          ...
          {benefits.map((benefit, index) => (
            <FadeIn key={benefit.number} delay={index * 0.1}>
              <article className="group border-b md:border-b-0 md:border-r last:border-r-0 border-black/10 p-6 sm:p-7 lg:p-8 hover:bg-mist transition-colors duration-500">

                <div className="flex items-start justify-between mb-10">
                  <div className="w-12 h-12 overflow-hidden bg-mist rounded-lg border border-black/5">
                    <img
                      src={benefit.img}
                      alt=""
                ...
                <h3 className="font-heading text-xl sm:text-2xl text-ink mb-3">
                  {benefit.title}
                </h3>
                ...
                <div className="mt-7 w-7 h-px bg-brass/50 group-hover:w-12 transition-all duration-300" />
