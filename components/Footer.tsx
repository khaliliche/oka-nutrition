...
export default function Footer() {
  return (
    <footer id="contact" className="bg-blue-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <a href="#offres" className="text-blue-light/80 hover:text-white transition">
                Nos offres
              </a>
            </li>
            <li>
              <a href="#avis" className="text-blue-light/80 hover:text-white transition">
                Avis
              </a>
            </li>
            <li>
              <a href="#faq" className="text-blue-light/80 hover:text-white transition">
                FAQ
              </a>
            </li>
          </ul>
      ...
      <div className="container mx-auto px-4">
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-center gap-2 text-xs text-blue-light/60 text-center">
          <span>© {new Date().getFullYear()} OKA Nutrition. Tous droits réservés.</span>
        </div>
      </div>
    </footer>
  );
