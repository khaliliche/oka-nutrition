        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative">
            <div className="relative w-full h-[280px] sm:h-[360px] md:h-[400px] rounded-[1.75rem] overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-4 start-4 bg-blue-dark/85 backdrop-blur-sm text-white text-xs font-bold px-3 py-1.5 rounded-full tracking-wide">
                {dict.results.before}
              </div>
              <div className="absolute top-4 end-4 bg-blue-bright/90 backdrop-blur-sm text-white text-xs font-bold px-3 py-1.5 rounded-full tracking-wide">
                {dict.results.after}
              </div>
