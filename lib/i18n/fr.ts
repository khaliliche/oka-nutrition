...
export const fr: Dictionary = {
  ...
  orderModal: {
    ...
    whatsappStepTitle: 'Commande confirmée ?',
    whatsappStepMessage: 'Souhaitez-vous aussi confirmer votre commande par WhatsApp ?',
    confirmWhatsapp: 'Confirmer avec message WhatsApp',
    skipWhatsapp: 'Confirmer sans message WhatsApp',
